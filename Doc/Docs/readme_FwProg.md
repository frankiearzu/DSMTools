...
/SCRIPTS/TOOLS
    ...
    /SCRIPTS/TOOLS/DSMLIB/        -- (ALL CAPITALS) Libraries ane extra files
            ...
            DsmMenuLib.lua
            DsmModelLib.lua
            DsmSetupMenuLib.lua          -- Model Setup Screens
            DsmSimMenuLib.lua    -- Simulation of AR631, FC6250HX  (For GUI development)
...
# Changes and fixes 
V0.55:
1. Attempt to reduce memory usuage on the black & white Full version to run on Radiomaster Boxter. Break the big scripts into smaller ones who are only alternative in memory (not at the same time)
