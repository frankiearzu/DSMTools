local toolName = "TNS|DSM Frwd Prog 2.2 (MIN-SETUP)|TNE"
...
local function ST_LoadMenu(menuId)
    ...
    elseif (menuId==0x1005) then
        ...
        local msg2 = "DSMDATA/"..MODEL.hashName
...
-- Load Model Config 
gc()
local r = assert(loadScript(DSMLIB_PATH.."apps/DsmMIN_P1.lua"), "Missing: ./DsmMIN_P1.lua")
